<template>
  <div class="goods">
    ...
    <van-cell-group class="goods-cell-group">
      ...
      <van-cell>
        <van-col span="16">
          <van-icon name="location-o" style="margin-right: 30px;" />收货人：{{data.buyerName}}</van-col>
    ...
    <van-card :num="data.num" :price="data.price" :desc="data.specs" :title="data.phoneName" :thumb="data.icon" />
